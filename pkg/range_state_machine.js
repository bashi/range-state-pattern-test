import { change_cursor } from '../drawing.js';
import * as __wbg_star0 from '../drawing.js';
...
/**
*/
export function setup_for_debug() {
...
export class RangeCanvas {
    ...
    static __wrap(ptr) {
        const obj = Object.create(RangeCanvas.prototype);
        obj.ptr = ptr;
    ...
    free() {
        ...
        wasm.__wbg_rangecanvas_free(ptr);
    }
    /**
    */
    constructor() {
        var ret = wasm.rangecanvas_new();
        return RangeCanvas.__wrap(ret);
    }
    /**
    * @param {number} x
    * @param {number} y
    */
    on_mouse_down(x, y) {
        wasm.rangecanvas_on_mouse_down(this.ptr, x, y);
    }
    /**
    * @param {number} x
    * @param {number} y
    */
    on_mouse_up(x, y) {
        wasm.rangecanvas_on_mouse_up(this.ptr, x, y);
    }
    /**
    * @param {number} x
    * @param {number} y
    */
    on_mouse_move(x, y) {
        wasm.rangecanvas_on_mouse_move(this.ptr, x, y);
    }
    /**
    * @param {string} key
    */
    on_key_up(key) {
        ...
        wasm.rangecanvas_on_key_up(this.ptr, ptr0, len0);
    }
}
...
function init(module) {
    ...
    const imports = {};
    imports.wbg = {};
    imports.wbg.__wbg_changecursor_77797ceff009a70a = function(arg0, arg1) {
        change_cursor(getStringFromWasm0(arg0, arg1));
    };
    ...
    imports['../drawing.js'] = __wbg_star0;
